...
Static Function GeraDados()
	...
	SRA->(DBSetOrder(1))
	SRA->(DbSeek(TQry->RD_FILIAL+TQry->RD_MAT))
	...
	While TQry->(!eof())
		_cMat 		:= TQry->RD_MAT
		_aDadFun	:= GetAdvFVal("SRA",{"RA_NOME","RA_ADMISSA","RA_SITFOLH","RA_CC","RA_CODFUNC","RA_SALARIO","RA_CARGO","RA_DEMISSA"},TQry->RD_FILIAL+_cMat,1)
