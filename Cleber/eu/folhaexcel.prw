...
Static Function GeraDados()
	...
	SRA->(DBSetOrder(1))
	SRA->(DbSeek(TQry->RC_FILIAL+TQry->RC_MAT))
	...
	While TQry->(!eof())
		...
		_aDadFun	:= GetAdvFVal("SRA",{"RA_NOME","RA_ADMISSA","RA_SITFOLH","RA_CC","RA_CODFUNC","RA_SALARIO","RA_CARGO"},TQry->RC_FILIAL+_cMat,1)
