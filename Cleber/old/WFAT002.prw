...
WSMETHOD GET consultacp WSRECEIVE numero, codCli WSSERVICE dadoscp
	...
	_cquer+="  E2_FORNECE AS FORNECEDOR,"
	_cquer+="  E2_LOJA AS LOJA,"
	_cquer+="  E2_NOMFOR AS NOME_FORNECEDOR,"
	...
	Begin Sequence
		...
		For nX := 1 to nTot
			...
			aArray := { { "E2_FILIAL"   , xFilial("SE2")  , NIL },;
				...
				{ "E2_EMISSAO"  , Padr(iif(ValType(aDados[nX]["E2_EMISSAO"]) <> "U", aDados[nX]["E2_EMISSAO"], ""),TamSx3("E2_EMISSAO")[1]), NIL },;
				{ "E2_VENCTO"   , Padr(iif(ValType(aDados[nX]["E2_VENCTO" ]) <> "U", aDados[nX]["E2_VENCTO" ], ""),TamSx3("E2_VENCTO" )[1]), NIL },;
				...
				{ "E2_VALOR"    , Padr(iif(ValType(aDados[nX]["E2_VALOR"  ]) <> "U", aDados[nX]["E2_VALOR"  ], ""),TamSx3("E2_VALOR"  )[1]), NIL }}
