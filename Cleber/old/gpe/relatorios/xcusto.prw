...
Static Function fReportDef()
	...
	TRCell():New(oSectDad, "BASE_INSS", "QRY_AUX", "Base_inss", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "VALOR_EMPRESA", "QRY_AUX", "Valor_empresa", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "VALOR_RAT", "QRY_AUX", "Valor_rat", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "VALOR_TERCEIROS", "QRY_AUX", "Valor_terceiros", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "VALOR_COLABORADOR", "QRY_AUX", "Valor_colaborador", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "LICENCA_MATERNIDADE", "QRY_AUX", "Licenca_maternidade", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "SALARIO_FAMILIA", "QRY_AUX", "Salario_familia", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "BASE_PIS", "QRY_AUX", "Base_pis", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "VALOR_PIS", "QRY_AUX", "Valor_pis", /*Picture*/, 4000, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	
	//Totalizadores
/*	oFunTot1 := TRFunction():New(oSectDad:Cell("(FORMAT (ISNULL(PIVOT_TABLE1.[0013],0)+ISNULL(PIVOT_TABLE1.[0014],0)+ISNULL(PIVOT_TABLE1.[0019],0)+ISNULL(PIVOT_TABLE1.[0020],0)+ISNULL(PIVOT_TABLE1.[0221],0)+ISNULL(PIVOT_TABLE1.[0225],0), 'C','PT-BR'))"),,"SUM",,,/*cPicture*/)*/
...
Static Function fRepPrint(oReport)
	...
	cQryAux := ""
	cQryAux += "SELECT * FROM (SELECT "		+ STR_PULA
	cQryAux += " PIVOT_TABLE1.PROCESSO AS PROCESSO"		+ STR_PULA
	...
	cQryAux += ", FORMAT(((ISNULL(PIVOT_TABLE1.[0013],0)+ISNULL(PIVOT_TABLE1.[0014],0)+ISNULL(PIVOT_TABLE1.[0019],0)+ISNULL(PIVOT_TABLE1.[0020],0)+ISNULL(PIVOT_TABLE1.[0221],0)+ISNULL(PIVOT_TABLE1.[0225],0)) *0.058), 'C','PT-BR')  AS [VALOR_TERCEIROS]"		+ STR_PULA
	...
	cQryAux += ", FORMAT( ((ISNULL(PIVOT_TABLE1.[0013],0)+ISNULL(PIVOT_TABLE1.[0014],0)+ISNULL(PIVOT_TABLE1.[0019],0)+ISNULL(PIVOT_TABLE1.[0020],0)+ISNULL(PIVOT_TABLE1.[0221],0)+ISNULL(PIVOT_TABLE1.[0225],0)) *0.20) "		+ STR_PULA
	...
	cQryAux += "WHERE  RD_FILIAL BETWEEN '0101' AND '0101' AND RD_PERIODO = '202204'"		+ STR_PULA
