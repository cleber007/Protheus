...
Data.....:              19/09/2019
Descricao / Objetivo:   Cadastro de Grupo de Produto
Uso......:               
Obs......:              
=====================================================================================
*/

User Function TBCF011(oSay,cArquivo,nHdlLog,nObjProc,nSucesso)
	...
	*/
	...
	nObjProc ++
		...
		lMsErroAuto := .F.
		Begin Transaction
			MSExecAuto({|x,y| MATA035(x,y)},aExecAuto,3) // SBM - GRUPO DE PRODUTOS
